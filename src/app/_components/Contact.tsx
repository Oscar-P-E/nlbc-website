  ...
  return (
    ...
    >
      <div className="mx-auto grid w-11/12 max-w-screen-xl grid-cols-12 justify-items-center gap-10 font-body">
        <div className="col-span-full flex w-full grow items-center rounded-xl border-4 border-zinc-900 py-14 shadow-lg prose-headings:my-0">
          <h1 className="mx-auto w-fit text-center text-zinc-900">
            Contact Us
          </h1>
        </div>

        <div className="col-span-full w-full rounded-xl bg-zinc-200 px-14 py-14 shadow-lg prose-headings:mt-0 prose-ul:ml-0 prose-ul:pl-0 prose-li:list-none prose-li:pl-0 md:col-span-6 xl:col-span-7">
        ...
        <div className="col-span-full rounded-xl bg-zinc-200 px-14 py-14 shadow-lg prose-headings:mt-0 prose-ol:ml-4 prose-ol:pl-0 md:col-span-6 xl:col-span-5">
          <h3 className="w-fit bg-gradient-to-r from-zinc-950 to-cyan-900 bg-clip-text pb-1.5  text-transparent ">
            Send an email...
          </h3>
          <form>
            ...
            <button
              type="submit"
              className="w-40 border-collapse rounded-xl bg-zinc-900 p-2 font-heading text-zinc-100 shadow-lg transition-all hover:bg-green-600 hover:text-white"
            >
              Send
            </button>
          </form>
