export default function Welcome() {
  return (
    <div className="prose md:prose-lg lg:prose-2xl prose-zinc prose-img:my-0 prose-img:rounded-xl mx-auto max-w-none bg-zinc-200 px-4 pb-20 pt-36">
      <div className="font-body mx-auto grid w-11/12 max-w-screen-xl grid-cols-3 justify-items-center gap-10 ">
        <div className="prose-headings:my-0 col-span-3 w-full rounded-xl border-4 border-zinc-100 py-14">
        ...
        <div className="prose-headings:mt-0 prose-p:mt-0 col-span-3 rounded-xl bg-zinc-100 px-14 py-14">
