    ...
    <>
      ...
      >
        <div className="mx-auto grid w-11/12 max-w-screen-xl grid-cols-12 justify-items-center gap-10 font-body">
          <div className="col-span-full flex w-full grow items-center rounded-xl border-4 border-zinc-50 py-14 shadow-lg prose-headings:my-0">
            <h1 className="mx-auto w-fit text-center  text-zinc-50">
              About Us
            </h1>
          </div>

          <div className="col-span-full  rounded-xl bg-zinc-200 px-14 py-14 italic text-opacity-80 shadow-lg prose-p:my-0 md:col-span-6 xl:col-span-4">
            <p>
          ...
          <div className="col-span-full rounded-xl bg-zinc-200 px-14 py-14 shadow-lg prose-headings:mt-0 prose-ol:ml-4 prose-ol:pl-0 md:col-span-full xl:col-span-8">
          ...
          <div className="col-span-full rounded-xl bg-zinc-500 px-14 py-14 italic text-zinc-100 text-opacity-80 shadow-lg prose-p:my-0 md:col-span-6 xl:col-span-4">
            <p>
              <FaQuoteLeft className="mb-8 opacity-30" />
          ...
          <div className="relative col-span-full grid grid-rows-1 gap-10 prose-headings:my-0 md:col-span-6 md:grid-rows-2 xl:col-span-4">
            ...
            <div className="row-span-1 flex flex-col justify-center rounded-xl bg-zinc-600 px-14 py-14 italic text-zinc-100 text-opacity-80 shadow-lg prose-p:my-0">
              <p>
                <FaQuoteLeft className="mb-8 opacity-30" />
          ...
          <div className="col-span-full rounded-xl bg-zinc-200 px-14 py-14 shadow-lg prose-headings:mt-0 prose-ol:ml-4 prose-ol:pl-0 md:col-span-full xl:col-span-7">
            <h2 className="w-fit bg-gradient-to-r from-zinc-950 to-cyan-900 bg-clip-text pb-1.5  text-transparent">
              Soul Winning
            </h2>
            <p>
          ...
          <div className="col-span-full rounded-xl  bg-zinc-600 px-14 py-14 italic text-zinc-100 text-opacity-80 shadow-lg prose-p:my-0 md:col-span-full xl:col-span-5">
            <p>
              <FaQuoteLeft className="mb-8 opacity-30" />
