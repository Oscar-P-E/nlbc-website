...
export default function About() {
  return (
    <>
      <div
        id="about"
        className="prose prose-lg prose-zinc mx-auto max-w-none bg-zinc-400 px-5 pb-24 pt-32 lg:prose-2xl prose-img:my-0"
      >
        <div className="mx-auto grid max-w-screen-xl grid-cols-1 justify-items-center gap-10 font-body md:w-11/12 md:grid-cols-12">
          ...
          <div className="col-span-full rounded-xl bg-zinc-200 px-6 py-10 italic text-opacity-80 shadow-lg prose-p:my-0 md:col-span-6 md:px-14 md:py-14 xl:col-span-4">
            <p>
          ...
          <div className="col-span-full rounded-xl bg-zinc-200 px-6 py-10 shadow-lg prose-headings:mt-0 prose-ol:ml-4 prose-ol:pl-0 md:col-span-full md:px-14 md:py-14 xl:col-span-8">
          ...
          <div className="col-span-full rounded-xl bg-zinc-500 px-6 py-10 italic text-zinc-100 text-opacity-80 shadow-lg prose-p:my-0 md:col-span-6 md:px-14 md:py-14 xl:col-span-4">
            <p>
              <FaQuoteLeft className="mb-8 opacity-30" />
          ...
          <div className="relative col-span-full grid grid-rows-1 gap-10 prose-headings:my-0 md:col-span-6 md:grid-rows-2 xl:col-span-4">
            ...
            <div className="row-span-1 flex flex-col justify-center rounded-xl bg-zinc-600 px-6 py-10 italic text-zinc-100 text-opacity-80 shadow-lg prose-p:my-0 md:px-14 md:py-14">
              <p>
                <FaQuoteLeft className="mb-8 opacity-30" />
          ...
          <div className="col-span-full rounded-xl bg-zinc-200 px-6 py-10 shadow-lg prose-headings:mt-0 prose-ol:ml-4 prose-ol:pl-0 md:col-span-full md:px-14 md:py-14 xl:col-span-7">
            <h2 className="w-fit bg-gradient-to-r from-zinc-950 to-cyan-900 bg-clip-text pb-1.5  text-transparent">
              Soul Winning
            </h2>
            <p>
          ...
          <div className="col-span-full rounded-xl  bg-zinc-600 px-6 py-10 italic text-zinc-100 text-opacity-80 shadow-lg prose-p:my-0 md:col-span-full md:px-14 md:py-14 xl:col-span-5">
            <p>
              <FaQuoteLeft className="mb-8 opacity-30" />
